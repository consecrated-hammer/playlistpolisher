...
Features for sorting, arranging, and structuring your playlists.
...
Features for managing tracks, content, and application settings.
...
Features for scheduling and automating playlist operations.

### Scheduled Operations

Expand automation capabilities for hands-free playlist maintenance:

- **Scheduled duplicate detection:** Run dedupe analysis on recurring schedule
- **Scheduled sorting:** Auto-sort playlists at specified intervals
- **Scheduled playlist operations:** Automate merge, split, or cleanup tasks
- **Conditional triggers:** Run operations when playlist criteria are met (e.g., exceeds track count, new tracks added)
